...
<head>
    ...
    <title>Official Participants Report</title>
    <style>
        body {
...
<body>
    ...
    <div class="report-info">
        <h3 style="color: black;">official Participants Report for {{ $startDate }} - {{ $endDate }}</h3>
        <p style="font-weight: bold;">
            Type of Report <span style="font-weight: normal;">(Official Participants)</span>
        </p>
