...
<body>
    ...
    <div class="report-info">
        <h3 style="color: black;">Performer Report for {{ $startDate }} - {{ $endDate }}</h3>
        <p style="font-weight: bold;">
            Type of Report <span style="font-weight: normal;">(Performer)</span>
        </p>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                <td>{{ $performers->name }}</td>
                <td>{{ $performers->year_level }}</td>
                <td>{{ $performers->email }}</td>
