    ...
    <body>
        ...
        <div class="report-info">
            <h3 style="color: black;">Auditionee Report for {{ $startDate }} - {{ $endDate }}</h3>
            <p style="font-weight: bold;">
                Type of Report <span style="font-weight: normal;">(Auditionee)</span>
            </p>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    <td>{{ $audtionees->name }}</td>
                    <td>{{ $audtionees->year_level }}</td>
                    <td>{{ $audtionees->email }}</td>
